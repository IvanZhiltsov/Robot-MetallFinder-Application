...
2. - Имеет возможность рисовать полигон на карте - область поиска
   ...
   **Каждый тип объекта имеет свой цвет, внутренняя область полигона штрихуется, при нарушении ограничений, объекты с ошибкой подсвечиваются**
3. - При загрузке данных с робота, они отображаются на карте
...
4. - Карту можно открыть с памяти устройства и, если тип карты позволяет, редактировать или загрузить в робота
   - Новые карту также можно сохранять
