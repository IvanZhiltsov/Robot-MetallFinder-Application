...
1. Скачайте и разархивируйте папку с готовым приложением (ссылка на Яндекс Диск: https://disk.yandex.ru/d/iXoZDTNDujEJNA)
...
4. Установите библиотеки из файла requirements.txt (для быстрой установки пропишите в терминале команду: *pip install -r requirements.txt*)
